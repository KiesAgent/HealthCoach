...
public class UserController implements Serializable {
    ...
    **********************************************************
    ...
    public String createAccount() {
        ...
        try {
            ...
            newUser.setTwoFactor(twoFactor);
    ...
    *****************************************************************
    ...
    public void deleteAccount() {
        ...
        try {
            ...
            // Delete all of the user recipes associated with the signed-in user whose primary key is userPrimaryKey
    ...
    ********************************************************
    ...
    /*
    *************************************************
    Delete all of the recipes that belong to the User
    ...
    *************************************************
    ...
    public void deleteAllUserRecipes(int primaryKey) {
        ...
        List<UserRecipe> userRecipeList = userRecipeFacade.findUserRecipesByUserPrimaryKey(primaryKey);

        if (!userRecipeList.isEmpty()) {
            // Java 8 looping over a list with lambda
            userRecipeList.forEach(userRecipe -> {

                    // Remove the user's file record from the database
                    userRecipeList.remove(userRecipe);
            });
        }
    }
