...
representing the UserPhoto table in the HealthCoachDB database.
 */
@Entity
...
public class UserPhoto implements Serializable {
    ...
    of the UserPhoto table in the HealthCoachDB database.
    ...
    represent a row in the UserPhoto table in the HealthCoachDB database.
    =================================================================
     */
    public UserPhoto() {
    }
