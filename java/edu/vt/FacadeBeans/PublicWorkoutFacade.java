...
@Stateless
public class PublicWorkoutFacade extends AbstractFacade<PublicWorkout> {
    /*
    ---------------------------------------------------------------------------------------------
     ...
     */
    public PublicWorkoutFacade() {
        super(PublicWorkout.class);
    }
    ...
    public PublicWorkout findByPublicWorkoutName(String recipe_name) {
        /*
        ...
        if (entityManager.createNamedQuery("PublicWorkout.findByName")
            ...
            return (PublicWorkout) (entityManager.createNamedQuery("PublicWorkout.findByName")
                    .setParameter("name", recipe_name)
                    .getSingleResult());
        }
    }
